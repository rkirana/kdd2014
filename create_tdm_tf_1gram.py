...
def main(train_file, test_file):
  ...
  scipy.io.mmwrite ('/home/kiran/kdd/tdms/x_train_bin_1gram.mtx', X, field = 'real')
  scipy.io.mmwrite ('/home/kiran/kdd/tdms/x_test_bin_1gram.mtx', X_test, field = 'real')
  myCols = tfv.get_feature_names ()
  myCols = DataFrame (myCols)
  myCols.to_csv ('/home/kiran/kdd/tdms/bin_1gram.csv', index=False)

  tfv = CountVectorizer (binary=0,ngram_range=(1, 1))
  X_all = traindata + testdata
  lentrain = len(traindata)
  tfv.fit(X_all)
  X_all = tfv.transform(X_all)
  X = X_all[:lentrain]
  X_test = X_all[lentrain:]
  scipy.io.mmwrite ('/home/kiran/kdd/tdms/x_train_tf_1gram.mtx', X, field = 'real')
  scipy.io.mmwrite ('/home/kiran/kdd/tdms/x_test_tf_1gram.mtx', X_test, field = 'real')
  myCols = tfv.get_feature_names ()
  myCols = DataFrame (myCols)
  myCols.to_csv ('/home/kiran/kdd/tdms/tf_1gram.csv', index=False)
